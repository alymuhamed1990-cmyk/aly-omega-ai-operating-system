...
function parseAny(h,source,base){
  const a=source.includes('via Jina')?parseMarkdown(h):[...parseRSS(h),...parseSearchHTML(h,base)];
  const seen=new Set();
  return a.filter(x=>{
